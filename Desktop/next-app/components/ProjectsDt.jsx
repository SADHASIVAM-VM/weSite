...
const ProjectDt = ()=> {
    ...
    return (
        <div className="bg-gray-100 px-5 md:px-20 py-5">
            <h1 className="font-bold text-2xl my-3">
                Developed more than <span className="text-green-400">100</span> projects <br /> in <span className="text-green-400">15</span> industries
            </h1>
